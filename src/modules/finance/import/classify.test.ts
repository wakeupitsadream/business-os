...
describe("внутренние переводы", () => {
  ...
  it("окно ±1 день режется по московским суткам", () => {
    // Списание 01.08 в 00:30 МСК и зачисление 31.07 в 23:30 МСК — соседние
    // дни владельца, пара обязана находиться.
    const late = row({ date: new Date("2026-07-31T21:30:00Z") }); // 00:30 МСК 1 августа
    const counter = candidate({ date: new Date("2026-07-31T20:30:00Z") }); // 23:30 МСК 31 июля
